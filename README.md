...
- 当前版本：**v2.0.3**(Python → Rust/Tauri 全栈重写后的当前主线;UI 视觉与 v1.0.4 字节级一致)
...
- Current version: **v2.0.3** (current mainline after the full Python → Rust/Tauri rewrite; UI byte-identical to v1.0.4)
...
asset = 'release/Codex-App-Transfer-v2.0.3-macOS-arm64.dmg'  # 替换成你下载的产物
